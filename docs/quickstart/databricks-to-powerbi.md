---
description: "Manage Databricks notebooks plus Power BI reports (PBIR) and semantic models end-to-end across dev, cert and prod with ade-ops — first deploy in about 20–30 minutes."
---
