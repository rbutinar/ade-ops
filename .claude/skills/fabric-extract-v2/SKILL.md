---
name: fabric-extract-v2
description: Parallel Fabric Workspace Metadata Extraction
---
...
1. `mcp__databricks__...` is **not** used here — we go through `FabricConnector.client.list_workspaces()` / `list_items()` directly.
