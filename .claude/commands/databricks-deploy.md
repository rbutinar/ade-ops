...
- Databricks MCP server configured (`dde` in `.mcp.json`)
...
- **MCP `dde` not available** → ask user to verify `.mcp.json` and restart Claude Code (see ONBOARDING.md step 7)
